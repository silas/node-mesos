...
Job.prototype.create = function(options, callback) {
  options = options || {};
...
Job.prototype.destroy = function(options, callback) {
...
Job.prototype.stats = function(options, callback) {
  if (typeof options === 'string') {
    options = { name: options };
  } else {
    options = options || {};
...
Job.prototype.search = function(options, callback) {
  if (typeof options === 'string') {
    options = { name: options };
